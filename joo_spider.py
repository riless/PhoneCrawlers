...
class JooSpider(CrawlSpider):
	...
	def parse_page(self, response):
		...
		# print "[+]",response.url
		location = hxs.select('//div[@id="mainCol"]/div[2]/div[1]/table/tr[2]/td[1]/table[2]/tr/td/a/text()').extract()
		phones = hxs.select('//div[@id="mainCol"]/div[2]/div[1]/table/tr[2]/td[2]/table/tr[3]/td/table[1]/tr/td[2]/text()').extract()
