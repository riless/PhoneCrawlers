...
class PaSpider(CrawlSpider):

	name = "pa"
	url = "www.petitesannonces.ch"
	country = 'ch'
	indicatif = '41'
	total =  9930000
	...
	def parse_page(self, response):
		...
		location = hxs.select('//div[@class="cnt"]/table/tr[4]/td[2]/a/text()').extract()
		phones = hxs.select('//div[@class="cnt"]/table/tr[position() = 5 or position() = 6]/td[2]/text()').extract()
